    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-dialog :title="title" :visible.sync="addFormVisible" :close-on-click-modal="false">
        <el-form :model="data" label-width="80px" :rules="addFormRules" ref="addForm">
          ...
          <el-form-item label="寄存时间" prop="ji">
            <el-input size="mini" v-model="data.ji" auto-complete="off"></el-input>
          </el-form-item>
           <el-form-item label="取出时间" prop="qu">
            <el-input size="mini" v-model="data.qu" auto-complete="off"></el-input>
          </el-form-item>
           <el-form-item label="寄存码" prop="ma">
            <el-input size="mini" v-model="data.ma" auto-complete="off"></el-input>
          </el-form-item>
        </el-form>
    ...
    data() {
      return {
        ...
        addFormRules: {
          ...
          ji:[
            {required: true, message: '请输入寄存时间', trigger: 'blur'}
          ],
          qu: [
            {required: true, message: '请输入取出时间', trigger: 'blur'}
          ],
          ma: [
            {required: true, message: '请输入寄存码', trigger: 'blur'}
          ],
