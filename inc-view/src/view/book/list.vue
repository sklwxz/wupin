  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
        ...
        <el-form role="form" size="small" id="projectForm" class="form-horizontal details">
          <el-row>
            <el-col :xs="colLayOut.xs" :lg="colLayOut.lg" :sm="colLayOut.sm" :md="colLayOut.md">
              <el-form-item :label-width="formLabelWidth" label="物品名称:" >
                <el-input size="mini" type="text" v-model="filters.name" clearable>
                </el-input>

              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="客户姓名:" >
                <el-input size="mini" type="text" v-model="filters.user" clearable>
                </el-input>

              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="寄存码:" >
                <el-input size="mini" type="text" v-model="filters.ma" clearable>
                </el-input>

              </el-form-item>
              <el-col :span="24">
                <el-form-item label-width="100px" style="float: right;margin-right: -150px;margin-top: -50px">
      ...
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="user" label="客户姓名"></el-table-column>
        <el-table-column prop="ji" label="寄存时间"></el-table-column>
        <el-table-column prop="qu" label="取出时间"></el-table-column>
        <el-table-column prop="ma" label="寄存码"></el-table-column>
